<template>
	<div id="app" class="container-fluid">
		...
		<transition name="fade" mode="out-in">
			<componente :is="componenteSelecionado"></componente>
		</transition>
		<hr>
		<b-button @click="adicionarCav" class="mb-4">Adicionar Cavaleiro</b-button>
		<transition-group name="slide" tag="div">
			<b-list-group v-for="(cav, i) in cavaleiros" :key="cav">
				<b-list-group-item @click="removerCav(i)">{{ cav }}</b-list-group-item>
			</b-list-group>
		</transition-group>
	</div>
</template>
...
export default {
	...
	data() {
		return{
			cavaleiros: ['Kanon', 'Saga', 'Shaka', 'Milo'],
	...
	methods: {
		adicionarCav() {
			...
			this.cavaleiros.push(s)
		},
		removerCav(indice) {
			this.cavaleiros.splice(indice, 1)
		},
